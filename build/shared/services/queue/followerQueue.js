...
exports.UnfollowerQueue = exports.FollowerQueue = void 0;
const bullmq_1 = require("bullmq");
const baseQueue_1 = require("./baseQueue");
class FollowerQueue extends baseQueue_1.BaseQueue {
...
exports.FollowerQueue = FollowerQueue;
class UnfollowerQueue extends baseQueue_1.BaseQueue {
    constructor(ququeName) {
        super(ququeName);
    }
    addToQueue(data) {
...
exports.UnfollowerQueue = UnfollowerQueue;
