...
exports.ResetPasswordMailWorker = void 0;
...
class ResetPasswordMailWorker {
    constructor() {
        this.mailQueue = new mailQueue_1.MailQueue('resetPasswordQueue');
        this.mailQueue.processQueue(this.sendResetMail);
    }
    prepareQueue(data, userDetails) {
        return __awaiter(this, void 0, void 0, function* () {
            const templatePath = path_1.default.join(`${__dirname}/../services/email/forgotPassword/forgotPasswordTemplate.ejs`);
...
exports.ResetPasswordMailWorker = ResetPasswordMailWorker;
